...
export function AssignmentsDue({
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-lg font-semibold tracking-tight">Bài tập sắp hết hạn</h2>
            ...
            .map((assignment) => (
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="pt-1">{getIcon(assignment.daysLeft, assignment.submitted)}</div>
                  <div className="flex-1 min-w-0">
                    <h3
                      className={cn(
                        "font-medium truncate group-hover:text-primary transition-colors",
                        assignment.submitted && "line-through text-muted-foreground",
                      )}
                    >
                      {assignment.title}
                    </h3>
                  ...
                  <div className="text-right">
                    {assignment.submitted ? (
                      ...
                      <p className={cn("text-xs font-semibold", getDueSoonColor(assignment.daysLeft))}>
