              ...
              {pendingMembers.map((pm) => (
                ...
                >
                  ...
                  <div className='flex items-center gap-2 shrink-0'>
                    <button
                      onClick={() => handleApprove(pm.user.id, pm.user.fullName || pm.user.email)}
                    ...
                    <button
                      onClick={() => handleReject(pm.user.id, pm.user.fullName || pm.user.email)}
                ...
                return (
                  ...
                  >
                    ...
                    <div className='flex items-center gap-3 shrink-0'>
                      <span
                        className={`px-2 py-1 rounded-md text-[10px] font-bold ${roleStyle.color}`}
                      >
                        {roleStyle.label}
                      </span>
                      {m.role !== 'owner' && (
